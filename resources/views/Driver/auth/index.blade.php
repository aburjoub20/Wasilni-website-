...
#mainNav.navbar-shrink {
  ...
  <a class="navbar-brand" href="{{url('/driver/book')}}"> <span> مرحبا {{Auth::user()->name}}    </span>  </a> 
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-4 col-xs-12">
                    <div class="row section-success ourTeam-box text-center">
                      <div class="col-md-12 section1">
                        <img style="width: 250px" src="{{asset("User/img/t1.jpg")}}">
                      </div>
                      <div class="col-md-12 section2 pb-3">
                        <p>ابراهيم غزل</p>
                        <span>مصمم و مطور مواقع </span>
                      </div>
                      <div class="col-md-12 section3">
                       <a href="https://www.facebook.com/people/%D8%A7%D8%A8%D8%B1%D8%A7%D9%87%D9%8A%D9%85-%D8%BA%D8%B2%D8%A7%D9%84/100007059196262/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                  ...
                  <div class="col-md-6 col-sm-4 col-xs-12">
                    <div class="row section-info ourTeam-box text-center">
                      <div class="col-md-12 section1">
                        <img style="width: 250px" src="{{asset("User/img/t2.jpg")}}">
                      </div>
                      <div class="col-md-12 section2 pb-3">
                        <p>اكرم شرباتي </p>
                        <span>مصمم و مطور مواقع </span>
                      ...
                      <div class="col-md-12 section3">
                        <a href="https://www.facebook.com/people/Akram-Sh/100075321385922/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                        {{-- <i class="fa fa-twitter" aria-hidden="true"></i>
                        <i class="fa fa-dribbble" aria-hidden="true"></i> --}}
                      </div>
                    </div>
