...
<html dir="rtl">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">وقت النهاي </th>

      <th scope="col">المكان </th>
    </tr>
  </thead>
  <tbody>
      @foreach($odriver as $odrivers)   
      <tr>
      <th scope="row">{{$loop->iteration}}</th>
      <td>{{$odrivers->driver->name}} </td>
      <td>{{$odrivers->endtime}}</td>
      <td>{{$odrivers->starttime}}</td> 

      <td>{{$odrivers->driver->location->name}} </td>
      </tr>
      @endforeach 
  </tbody>
</table>
